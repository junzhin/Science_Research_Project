...
class BaseSolver:
    ...
    def test(self):
        ...
        writer = SummaryWriter(log_dir = self.args.save_dir + '/logtestresults/', comment = 'validating')
        ...
        writer.add_scalar('Prec/test/',Total_precs/len(self.test_data['loader']), self.epoch)
        writer.flush()
        writer.close()
